  ...
  describe 'POST #reset_password' do
    context 'with valid reset password token' do
      it 'resets the password and returns a success message' do
        ...
        post :reset_password, params: { reset_password_token: token, password: 'newpassword123', password_confirmation: 'newpassword123' }
    ...
    context 'with invalid reset password token' do
      it 'does not reset the password and returns an error' do
        post :reset_password, params: { reset_password_token: 'wrong', password: 'newpassword123', password_confirmation: 'newpassword123' }
