...
RSpec.describe Workspaces::Update, type: :interactor do
  ...
  let(:context) { Workspaces::Update.call(id: workspace.id, user: user, workspace_params: { name: new_name }) }
  ...
  describe '.call' do
    ...
    context 'when the update fails' do
      let(:context) { Workspaces::Update.call(id: workspace.id, user: user, workspace_params: { name: nil }) }
