...
RSpec.describe Workspaces::Create, type: :interactor do
  ...
  let(:context) { Workspaces::Create.call(workspace_params: valid_attributes, user: user) }
  let(:context_fail) { Workspaces::Create.call(workspace_params: invalid_attributes, user: user) }
